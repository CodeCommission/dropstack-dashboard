    ...
    return (
      <StyledLayout>
        <Helmet
          htmlAttributes={{
            lang: 'en',
            style: 'overflow-y: scroll;overflow-x: hidden;height: 100%;margin: 0;padding: 0;'
          }}
          bodyAttributes={{style: 'height: 100%;margin: 0;padding: 0;'}}
        />
        {this.props.userId && (
          <TopNavigationContainer>
            <TopNavigation>
              <a href="/">
                <TopNavigationImage src="/dropstack.svg" />
              </a>
              <TopNavigationList>
                ...
                <TopNavigationListItem fullSize>
                  <TopNavigationLogin>
        ...
        <Footer>
          <div>
            {appPackage.name} v{appPackage.version}
          </div>
        </Footer>
      </StyledLayout>
    );
