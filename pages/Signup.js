...
const SignupLoginLink = styled.a`
  font-size: 11px;
  color: white;
  width: 153px;
  text-align: center;
        ...
        <SignupContainer>
          {
            !this.props.message &&
            <form method="POST">
              <SignupInput type="text" name="username" placeholder="email" />
              <SignupInput type="password" name="password" placeholder="password" />
              <SignupInput type="password" name="vpassword" placeholder="password" />
              <br/>
              <SignupButton type="submit">sign up</SignupButton>
              <SignupLoginLink href="/login">log in</SignupLoginLink>
            </form>
          }
          {
            this.props.message &&
